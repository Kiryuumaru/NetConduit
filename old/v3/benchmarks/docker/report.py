...
def main():
    ...
    print()
    print("All benchmarks run in Docker containers on loopback (127.0.0.1), identical workloads,")
    print("5 runs with median reported. CPU-pinned via `--cpuset-cpus=0,1` (2 cores).")
    print()
    print("**Fairness controls:** Both Go and .NET containers pinned to same 2 CPU cores,")
    print("GOMAXPROCS=2, `--network=none` (loopback only), identical Docker isolation.")
    print()
