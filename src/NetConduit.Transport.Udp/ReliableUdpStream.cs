...
/// <summary>
/// Reliable ordered stream over UDP. Implements stop-and-wait with per-packet ack and retransmit.
/// </summary>
internal sealed class ReliableUdpStream : Stream
{
    ...
    public override async ValueTask<int> ReadAsync(Memory<byte> buffer, CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            ...
            if (_finReceived && !_receiveChannel.Reader.TryPeek(out _))
                return 0;
    ...
    public override async ValueTask WriteAsync(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken = default)
    {
        ...
        var maxPayload = Math.Max(1, _options.Mtu - 7);
