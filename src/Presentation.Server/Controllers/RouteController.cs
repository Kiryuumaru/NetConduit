...
public class RouteController(PortRouteService portRouteService) : ControllerBase
{
    ...
    {
        return _portRouteService.Get(id);
    }
    ...
    {
        return _portRouteService.Create(portRouteAddDto);
    }
    ...
    {
        return _portRouteService.Edit(id, portRouteEditDto);
    }
    ...
    {
        return _portRouteService.Delete(id);
    }
}
